...
const Result = () => {
  ...
  return (
    <div className="container mx-auto my-28">
      ...
      <div className="xl:flex xl:justify-center lg:flex lg:justify-center lg:space-y-0 md:flex md:justify-center  mx-auto my-6 gap-2 sm:block space-y-6 md:space-y-0">
