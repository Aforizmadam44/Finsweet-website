  ...
  return (
    <div className="flex flex-col items-center justify-center mt-0">
      ...
      <div className="border-t-2 my-3 xl:grid xl:grid-cols-4 lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 sm:grid sm:grid-cols-1 gap-4">
        <div className="flex gap-2 my-3 lg:my-0 items-center hover:scale-105 hover:shadow-xl rounded-xl transition-all duration-500 cursor-pointer shadow-xl p-4">
          <div>
        ...
        <div className="flex  my-3 lg:my-0 p-4 hover:scale-105 hover:shadow-xl transition-all duration-500 cursor-pointer rounded-xl gap-2 shadow-xl  text-center">
        ...
        <div className="flex items-center my-3 lg:my-0 earningsCard hover:scale-105 hover:shadow-xl transition-all duration-500 cursor-pointer  gap-2 p-4 rounded-xl shadow-xl  text-center">
          <div>
